...
class AllEmployeeSalaryTable(tk.Frame):
    def __init__(self,root):
        ...
        self.sheet_demo.set_column_widths([150 for c in range(5)])
        ...
        self.headers = [f" {c}" for c in ( 'Emri', 'Mbiemri', 'Page Orare', 'Oret', 'Paga neto')]
