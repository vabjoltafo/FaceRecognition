...
from Repositories.EmployeeRepository import getActivityOfEmployees
from Utilities.Convertors import editListOfActivities


class ActivityEmployeeTable(tk.Frame):
    def __init__(self,root):
        ...
        #
        # self.response = ()
        self.records = editListOfActivities(getActivityOfEmployees())
        #
        #
        ...
        self.headers = [f" {c}" for c in ( 'Emri', 'Mbiemri','Pozicioni', 'Data', 'Ora Hyrje',
                                          'Ora Dalje')]
