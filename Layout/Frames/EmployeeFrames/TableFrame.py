...
from Repositories.EmployeeRepository import getTheInfomationFromEmployees
...
class TableFrame(tk.Frame):
    def __init__(self,root):
        ...
        self.sheet_demo.highlight_cells(column=6, bg="#3A3A3A", fg="white", canvas="header")
        ...
        self.headers = [f" {c}" for c in ('Id', 'Emri', 'Mbiemri', 'Pozicioni', 'Datëlindja',
                                          'Telefoni', 'Email')]
