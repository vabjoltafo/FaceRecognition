...
from Repositories.EmployeeRepository import get10LatestEmployees


class LatestRegisteredEmployeesFrame(Frame):
    def __init__(self,root):
        ...
        self.records = get10LatestEmployees()
        ...
        self.headers = [f" {c}" for c in ('Emri', 'Mbiemri', 'Pozicioni')]
